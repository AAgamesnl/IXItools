...
class ApplianceManagerApp(ctk.CTkFrame):
    ...
    def _setup_layout(self):
        ...
        # Arrange panels horizontally: filter on the left, results in the center,
        # and the cart on the right. Only the results panel should expand
        # horizontally while all panels take the full height of the window.
        self.rowconfigure(0, weight=1)
        self.columnconfigure(0, weight=0)  # Filter panel
        self.columnconfigure(1, weight=1)  # Results panel (expandable)
    ...
    def _build_ui(self):
        ...
        self.cart_panel.grid(row=0, column=2, sticky="nse", padx=(2, 5), pady=5)
